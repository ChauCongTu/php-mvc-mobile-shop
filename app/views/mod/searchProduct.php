                ...
                <div class="form-body">
                    <div class="filter-list">
                        <ul class="filter-list-li">
                            <li><a href="" class="color-black"> &#8226; Mới nhất trước</a></li>
                            <li><a href="" class="color-black"> &#8226; Cũ nhất trước</a></li>
                            <li><a href="" class="color-black"> &#8226; Rẻ nhất trước</a></li>
                            <li><a href="" class="color-black"> &#8226; Nổi bật nhất</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="form-body">
                    <div class="danhmuc-body">
                        ...
                        <div class="danhmuc-sanpham">
                            ...
                            <div class="danhmuc-info">
                                <a href="" class="color-black">
                                    <div class="danhmuc-name">Samsung galaxy s23 Ultra (Hàng cũ)</div>
                                </a>
                                <div class="slick-price">
                                    <div class="slick-sale-price">19.999.000đ</div>
                                    <div class="slick-origin-price"> <del> 31.999.000đ</del></div>
                                </div>
                            </div>
                        </div>
